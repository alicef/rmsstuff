...
<script type="text/javascript"
  src="/api/robot_environments/interfaces/drone_interface/keyboardteleop.js"></script>
<!--script type="text/javascript"
...
<body onload="start();">
	...
	<h2 style="color:aliceblue">Parrot AR.Drone</h2>
		...
		<tr>
			<th>
			<p style="color:yellow">takeoff with "enter" and "spacebar" to land <br> use "A" and "D" to turn<br> use "W" and "S" to move forward and back<br>use "I" for up and "K" for down<br>"Q" and "E" move laterally left and right</p>

			</th>
			<th width="33%" style="color:blue">
                        <p style="color:blue"> use slider to adjust speed<br></p>
		...
		<tr>
			<td width="50%">
			<img id="liveVideoMove" src="http://138.16.160.10:8080/stream?topic=/ardrone/image_raw?quality=60" alt="no live video">
			</td>
		</tr>
		<tr>
			<td width="50%">
			<img id="liveVideoStay" src="http://138.16.160.10:8080/stream?topic=/camera/image_raw?quality=60?width=500?height=300" alt="no live video">
			</td>
		</tr>
                <tr>
		    <td width="33%"></td>
